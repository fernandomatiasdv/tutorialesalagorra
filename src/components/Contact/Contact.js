            ...
            >
              ...
              <FormItem label="E-mail">
                {getFieldDecorator("email", {
                  rules: [
                    {
                      required: true,
                      message: "Ingresá tu correo, asi puedo responderte!",
                      whitespace: true,
                      type: "email"
                    }
                  ]
              ...
              <FormItem label="Message">
                {getFieldDecorator("message", {
                  rules: [
                    { required: true, message: "Porfa, completa este campo", whitespace: true }
                  ]
                })(
              ...
              <FormItem>
                ...
                {*/}
                <p>
                  Ya sea para dar clases o desarrollarte una página web escribime a fernandomatiasdv@gmail.com  
                </p><br />
                <p>
                  O bien mandame un WhatsApp al +541125857872
                </p>
            {/* --- STYLES --- */}
            <style jsx>{`
              .form {
